...
const translations = {
    ua: {
        ...
        questions: [
            ...
            { question: "Що означає термін 'Уязвимість нульового дня' (Zero-Day)?", answers: ["Уязвимість, яку виправляють за 0 днів", "Помилка, яка зникає при перезавантаженні", "Пролом у безпеці, для якого розробники ще не створили патч виправлення", "Вірус, який активується рівно о півночі"], correct: 2 }
        ]
    },
    ru: {
        startSubtitle: "Ready to test your power?",
        ...
        questions: [
            ...
            { question: "Что означает термин 'Уязвимость нулевого дня' (Zero-Day)?", answers: ["Уязвимость, которую исправляют за 0 дней", "Ошибка, исчезающая при перезагрузке", "Брешь в безопасности, для которой разработчики еще не создали патч исправления", "Вирус, активирующийся ровно в полночь"], correct: 2 }
        ]
    },
    en: {
        startSubtitle: "Ready to test your power?",
